...
def write_test_files(mds_core_path, package_names):
  for package, test_file_string in compute_test_files(mds_core_path).items():
    ...
    mds_integration_path = os.path.join(mds_core_path, 'tests', 'autogenerated')
    test_file_path = os.path.join(mds_integration_path, '{}.api.spec.js'.format(package))
